 ...
 */
    [_QWERTY] = LAYOUT_elora_hlc(
     ...
     KC_LCTL,   SE_Z ,   SE_X ,   SE_C ,   SE_V ,   SE_B , KC_LEFT, KC_DOWN,     KC_UP  , KC_RGHT,   SE_N ,   SE_M , SE_COMM, SE_DOT , SE_MINS, KC_ENT ,
                                KC_LALT, KC_RGUI, KC_LSFT, KC_SPC , SYM    ,     KC_RGUI, KC_BSPC, KC_RSFT, KC_MPLY,     FN ,
 ...
 */
    [_FN] = LAYOUT_elora_hlc(
      ...
      _______, KC_F11 , KC_F12 , _______, _______, _______,                                        _______, UG_NEXT, UG_HUEU, UG_SATU, UG_VALU, _______,
