 ...
 */
    [_QWERTY] = LAYOUT_elora_hlc(
     ...
     KC_LCTL,   SE_Z ,   SE_X ,   SE_C ,   SE_V ,   SE_B , KC_LEFT, KC_DOWN,     KC_UP  , KC_RGHT,   SE_N ,   SE_M , SE_COMM, SE_DOT , SE_MINS, KC_ENT ,
                                MS_BTN1, MS_BTN2, KC_LSFT, KC_SPC , SYM    ,     KC_RGUI, KC_BSPC, KC_RSFT, KC_MPLY, KC_RALT,
 ...
 */
    [_SYM] = LAYOUT_elora_hlc(
      ...
      _______,  SE_DLR,   SE_AT, SE_PERC, SE_SLSH, _______, _______, _______,    _______, _______, _______, SE_BSLS, SE_PLUS, SE_ASTR, _______, _______,
                                 _______, _______, _______, _______, _______,    FN     , _______, _______, _______, _______,
